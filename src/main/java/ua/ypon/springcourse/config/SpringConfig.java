package ua.ypon.springcourse.config;
...
public class SpringConfig implements WebMvcConfigurer {
    ...
    @Bean
    public LocalSessionFactoryBean sessionFactory() {//Отримуємо сесію для роботи з БД
        LocalSessionFactoryBean sessionFactory = new LocalSessionFactoryBean();
        sessionFactory.setDataSource(dataSource());//BD
        sessionFactory.setPackagesToScan("ua.ypon.springcourse.models");//сканує папку з сутностями в пошуку анотації @Entity
